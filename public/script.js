...
async function generateRPHContent(formData, rptData, bukuTeksData, previousActivities) {
   ...
   // === PERUBAHAN DI SINI ===
    ...
    return {
        ...
        kriteriaCemerlang: `Murid berjaya melakukan 5 dari 5 aktiviti ${spTextShortened} dengan cemerlang dan menunjukkan kefahaman mendalam.`,
        kriteriaSederhana: `Murid berjaya melakukan 3 dari 5 aktiviti ${spTextShortened} dengan baik dan memahami konsep asas.`,

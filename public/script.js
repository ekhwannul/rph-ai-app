...
async function generateRPHContent(formData, rptData, bukuTeksData, previousActivities) {
   ...
   // === PERUBAHAN DI SINI ===
    ...
    return {
        ...
        kriteriaCemerlang: `Murid berjaya ${spTextClean} dengan melakukan 5 dari 5 aktiviti dengan cemerlang dan menunjukkan kefahaman mendalam.`,
        kriteriaSederhana: `Murid berjaya ${spTextClean} dengan melakukan 3 dari 5 aktiviti dengan baik dan memahami konsep asas.`,
        kriteriaBimbingan: `Murid berjaya ${spTextClean} dengan melakukan 2 dari 5 aktiviti dengan bimbingan guru.`,
